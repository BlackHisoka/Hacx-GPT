...
############################ API Details ############################
    ...
    if API_PROVIDER not in _PROVIDERS:
       sys.exit(
           ...
           + "\nSee: https://github.com/BlackHisoka/Hacx-GPT"
        )
...
╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝     ╚═════╝ ╚═╝        ╚═╝
        """, style="bold cyan")
        info_line = Text("A Professional, Advanced Uncensored AI, Developed by BlackHisoka", style="green")
...
""" 
    ...
    def __init__(self, api_key: str, ui: UI):
        ...
        self.client = openai.OpenAI(
            ...
            default_headers={"HTTP-Referer": "https://github.com/BlackHisoka", "X-Title": "HacxGPT-CLI"},
        )
...
[bold yellow]Github Repository:[/bold yellow]
  • [link=https://github.com/BlackHisoka/Hacx-GPT]GitHub:  github.com/BlackHisoka/Hacx-GPT[/link]


[bold yellow]Connect:[/bold yellow]
  • [link=https://github.com/BlackHisoka]GitHub:  github.com/BlackHisoka[/link]
